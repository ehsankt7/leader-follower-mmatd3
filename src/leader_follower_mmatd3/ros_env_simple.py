...
def check_pos(x, y):
    ...
    ##### STAGE 0 #################################################################
    # wall number 1:
    if  4.25 < x and 1.5 < y < 4.5:
        goal_ok = False
                        
    # wall number 2:
    if  4.25 < x and -4.5 < y < -1.5:
        goal_ok = False   

    # wall number 3:
    if  -4.25 > x and -1.5 < y < 1.5:
        goal_ok = False 

    # cylinder number 1:
    if  -1.25 < x < 1.25 and -1.25 < y < 1.25:
        goal_ok = False 
    # room walls    
...
class GazeboEnv:
    ...
    def step(self, action):
        ...
        # Goal is reached within 0.4 m of the target.
    ...
    def reset(self):
        ...
        while not position_ok_r1:
            x_r1 = np.random.uniform(-6, 6)
            y_r1 = np.random.uniform(-6, 6)
    ...
    def change_goal(self):
        # Sample a valid goal at least 1.5 m from both robots.
        goal_ok_r1 = False
        while not goal_ok_r1:
            self.goal_x = random.uniform(-6.0, 6.0)
            self.goal_y = random.uniform(-6.0, 6.0)
    ...
    def random_box(self):
        ...
        for i in range(4):
            ...
            while not box_ok:
                ...
                y = np.random.uniform(-7.2, 7.2)
                yaw_angle = np.random.uniform(0.0, 3.14)
    ...
    #     # robot 1
    #     markerArray_r1 = MarkerArray()
    #     marker_r1 = Marker()
    #     marker_r1.header.frame_id = "odom"
    #     marker_r1.type = marker_r1.CYLINDER
    #     marker_r1.action = marker_r1.ADD
    #     marker_r1.scale.x = 0.25
    #     marker_r1.scale.y = 0.25
    #     marker_r1.scale.z = 0.01
    #     marker_r1.color.a = 1.0
    #     marker_r1.color.r = 1.0
    #     marker_r1.color.g = 1.0
    #     marker_r1.color.b = 1.0
    #     marker_r1.pose.orientation.w = 1.0
    #     ## need to mark the goal position for both robots 
    #     marker_r1.pose.position.x = self.goal_x
    #     marker_r1.pose.position.y = self.goal_y
    #     marker_r1.pose.position.z = 0

    #     markerArray_r1.markers.append(marker_r1)
    #     self.publisher_goal.publish(markerArray_r1)


    #     ## need to mark the actions of both of the agents 
    #     # robot 1
    #     markerArray2_r1 = MarkerArray()
    #     marker2_r1 = Marker()
    #     marker2_r1.header.frame_id = "odom"
    #     marker2_r1.type = marker2_r1.CUBE
    #     marker2_r1.action = marker2_r1.ADD
    #     marker2_r1.scale.x = abs(action[0])
    #     marker2_r1.scale.y = 0.1
    #     marker2_r1.scale.z = 0.01
    #     marker2_r1.color.a = 1.0
    #     marker2_r1.color.r = 1.0
    #     marker2_r1.color.g = 0.0
    #     marker2_r1.color.b = 0.0
    #     marker2_r1.pose.orientation.w = 1.0
    #     marker2_r1.pose.position.x = 5
    #     marker2_r1.pose.position.y = 0
    #     marker2_r1.pose.position.z = 0

    #     markerArray2_r1.markers.append(marker2_r1)
    #     self.publisher2_r1.publish(markerArray2_r1)
        
    #     # robot 2
    #     markerArray2_r2 = MarkerArray()
    #     marker2_r2 = Marker()
    #     marker2_r2.header.frame_id = "odom"
    #     marker2_r2.type = marker2_r2.CUBE
    #     marker2_r2.action = marker2_r2.ADD
    #     marker2_r2.scale.x = abs(action[2])
    #     marker2_r2.scale.y = 0.1
    #     marker2_r2.scale.z = 0.01
    #     marker2_r2.color.a = 1.0
    #     marker2_r2.color.r = 0.0
    #     marker2_r2.color.g = 1.0
    #     marker2_r2.color.b = 1.0
    #     marker2_r2.pose.orientation.w = 1.0
    #     marker2_r2.pose.position.x = 5
    #     marker2_r2.pose.position.y = 0
    #     marker2_r2.pose.position.z = 0

    #     markerArray2_r2.markers.append(marker2_r2)
    #     self.publisher2_r2.publish(markerArray2_r2)

    #     #Robot 1
    #     markerArray3_r1 = MarkerArray()
    #     marker3_r1 = Marker()
    #     marker3_r1.header.frame_id = "odom"
    #     marker3_r1.type = marker3_r1.CUBE
    #     marker3_r1.action = marker3_r1.ADD
    #     marker3_r1.scale.x = abs(action[1])
    #     marker3_r1.scale.y = 0.1
    #     marker3_r1.scale.z = 0.01
    #     marker3_r1.color.a = 1.0
    #     marker3_r1.color.r = 1.0
    #     marker3_r1.color.g = 0.0
    #     marker3_r1.color.b = 0.0
    #     marker3_r1.pose.orientation.w = 1.0
    #     marker3_r1.pose.position.x = 5
    #     marker3_r1.pose.position.y = 0.2
    #     marker3_r1.pose.position.z = 0

    #     markerArray3_r1.markers.append(marker3_r1)
    #     self.publisher3_r1.publish(markerArray3_r1)
        
        
    #     #Robot 2
    #     markerArray3_r2 = MarkerArray()
    #     marker3_r2 = Marker()
    #     marker3_r2.header.frame_id = "odom"
    #     marker3_r2.type = marker3_r2.CUBE
    #     marker3_r2.action = marker3_r2.ADD
    #     marker3_r2.scale.x = abs(action[3])
    #     marker3_r2.scale.y = 0.1
    #     marker3_r2.scale.z = 0.01
    #     marker3_r2.color.a = 1.0
    #     marker3_r2.color.r = 0.0
    #     marker3_r2.color.g = 1.0
    #     marker3_r2.color.b = 1.0
    #     marker3_r2.pose.orientation.w = 1.0
    #     marker3_r2.pose.position.x = 5
    #     marker3_r2.pose.position.y = 0.2
    #     marker3_r2.pose.position.z = 0

    #     markerArray3_r2.markers.append(marker3_r2)
    #     self.publisher3_r2.publish(markerArray3_r2)
